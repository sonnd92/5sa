...
/**
 * Created by sonnd on 24/10/2015.
 */
public class GetNewShippingOrder extends AsyncTask<String, Void, JSONObject> {
    ...
    public GetNewShippingOrder(OnTaskCompleted _listener, ShippingOrderService service,  String _keyword, int _status) {
        listener = _listener;
        keyword = _keyword;
        status = _status;
    ...
    protected JSONObject doInBackground(String... params) {
        return service.GetNewShippingOrder(keyword, status, Integer.parseInt(params[0]) , Integer.parseInt(params[1]));
    }
