 ...
 */
public class RemovePinnedFbFeed extends AsyncTask<String, Void, JSONObject> {
    private OnSendRequestCompleted mListener;
    private Context mContext;
    private OtherService mService;

    public RemovePinnedFbFeed(Context mContext,OnSendRequestCompleted mListener) {
    ...
    protected JSONObject doInBackground(String... params) {
        return mService.RemoveFavoriteOfShipper(Integer.parseInt(params[0]), Integer.parseInt(params[1]), params[2]);
    }
