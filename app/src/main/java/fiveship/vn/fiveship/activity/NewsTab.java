...
public class NewsTab extends Fragment {
    ...
    public static NewsTab newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRootView = inflater.inflate(R.layout.fragment_news_tab, container, false);
    ...
    public class InternalScrollListener extends OnScrollListenerFactory {
        ...
        public AsyncTask<String, Void, JSONObject> getAsyncRequest() {
            return new GetNewses(getCallbackMethod(), service, mKeyword);
        }
    ...
    public class GetNewses extends AsyncTask<String, Void, JSONObject> {
        private NewsService mService;
        private String keyword;
        private OnTaskCompleted mListener;

        public GetNewses(OnTaskCompleted mListener, NewsService mService, String keyword) {
        ...
        protected JSONObject doInBackground(String... params) {
            return mService.GetListNews(keyword, Integer.parseInt(params[0]), Integer.parseInt(params[1]));
        }
